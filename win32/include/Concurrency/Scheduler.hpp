...
namespace Concurrency
{
     ...
     * and running scheduled tasks. It inherits from IScheduler and IRunnable.
     */
    ...
    public:
         ...
         *
         * @param workerThreadPriority The priority of the worker threads to be managed by this scheduler.
         */
         ...
         * 
         * Overrides IRunnable::Run() to implement the core scheduling
